...
data = dict(
    ...
    val=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                img_scale= [(4096, 1000), (4096, 1100),  (4096, 1200),(4096, 1300), (4096, 1400)],# 采用多尺度预测(4096, 600),  (4096, 800), (4096, 1000),#
                flip=True,
                transforms=[
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=   [(4096, 1000),   (4096, 1100),(4096, 1200),(4096, 1300), (4096, 1400), (4096, 1600)],# [(1400, 600)],#采用多尺度预测(4096, 1000),(4096, 1200), (4096, 1400),(4096, 1600),
                flip=True,
                transforms=[
                    dict(type='Resize', keep_ratio=True),
                    dict(type='RandomFlip'),
