...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='CrossEntropyLoss_Smooth', use_sigmoid=True, loss_weight=1.0,smoothing=0.2),
        loss_bbox=dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            score_thr=0.00001,
            nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.00001),
            max_per_img=320)))
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale= [(4096, 1000),  (4096, 1200), (4096, 1400)],# 采用多尺度预测(4096, 600),  (4096, 800), (4096, 1000),#
        flip=True,
        transforms=[
