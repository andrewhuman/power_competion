...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_cls=dict(
            type='CrossEntropyLoss_Smooth', use_sigmoid=True, loss_weight=1.0),
        loss_bbox=dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            score_thr=0.00003,
            nms=dict(type='soft_nms', iou_thr=0.5, min_score=0.00003),
            max_per_img=200)))
...
resume_from = None
workflow = [('train', 1)]
#work_dir = './work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_underwater_rpn_double_clear'
#gpu_ids = range(0, 2)
